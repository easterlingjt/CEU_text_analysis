...
#<<<<<<< HEAD
parties <- c("conservative party", "(?i)Tor(ies|y)","ukip","(?i)Labour party", "labour", "liberal democrats", "scottish national party", "green party")
#=======
#>>>>>>> 612a2152f342ad8d42caff0bd66bd1f1bc325221

#parties <- c("conservative party", "Tories","ukip","labour party", "labour", "liberal democrats", "scottish national party", "green party")
```
...
# Authentication
drive_auth(email ="easterlingjt@gmail.com")
...
movie_reviews <- read_csv("reviews.csv")
